...
public class PaxosLog {
    ...
    /**
     * Returns all entries in the Paxos log
     * Used for log recovery during leader changes
     * @return Hashtable containing all log entries
     */
    public synchronized Hashtable<Integer, PaxosInstance> getEntries() {
        return this.log;
    }
}
